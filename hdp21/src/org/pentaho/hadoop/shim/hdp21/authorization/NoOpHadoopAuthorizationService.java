...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.hdp21.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.common.CommonPigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.hdp21.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.hdp21.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.hdp21.HBaseShimImpl() );
    try {
